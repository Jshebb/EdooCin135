# 0 "C:/Users/ebber/CLionProjects/RevisaoEdoo/produto.cpp"
# 1 "C:\\Users\\ebber\\CLionProjects\\RevisaoEdoo\\cmake-build-debug//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "C:/Users/ebber/CLionProjects/RevisaoEdoo/produto.cpp"
...
# 5 "C:/Users/ebber/CLionProjects/RevisaoEdoo/produto.cpp" 2
# 1 "C:/Users/ebber/CLionProjects/RevisaoEdoo/produto.h" 1
...
# 11 "C:/msys64/mingw64/include/wchar.h" 3
...
# 320 "C:/msys64/mingw64/include/wchar.h" 3
...
# 1132 "C:/msys64/mingw64/include/wchar.h" 3
...
# 1305 "C:/msys64/mingw64/include/wchar.h" 3
  errno_t __attribute__((__cdecl__)) _wctime_s(wchar_t *, size_t, const time_t *);
# 1324 "C:/msys64/mingw64/include/wchar.h" 3
...
# 1435 "C:/msys64/mingw64/include/wchar.h" 3
}
...
# 316 "C:/msys64/mingw64/include/sec_api/wchar_s.h" 3
...
# 1441 "C:/msys64/mingw64/include/wchar.h" 2 3
...
# 184 "C:/msys64/mingw64/include/ctype.h" 3
...
# 495 "C:/msys64/mingw64/include/stdlib.h" 3
...
# 572 "C:/msys64/mingw64/include/stdlib.h" 3
...
# 9 "C:/Users/ebber/CLionProjects/RevisaoEdoo/produto.h" 2

# 9 "C:/Users/ebber/CLionProjects/RevisaoEdoo/produto.h"
using namespace std;
...
class fruta : public produto{
  public:
    float calcularValorEstoque();
    fruta(string nome, float preco, int qnt);
    fruta();
};

class verdura : public produto{
  public:
    float calcularValorEstoque();
    verdura(string nome, float preco, int qnt);
    verdura();
};

class legumes : public produto{
  public:
    float calcularValorEstoque();
    legumes(string nome, float preco, int qnt);
    legumes();
};
# 6 "C:/Users/ebber/CLionProjects/RevisaoEdoo/produto.cpp" 2
using namespace std;

produto::produto(string nome, float preco, int qnt):
nome(nome),preco(preco),qnt(qnt)
                                                      {};
produto::produto(){};
...
fruta::fruta(string nome, float preco, int qnt):
produto(nome, preco, qnt)
{};

fruta::fruta(){};

float fruta::calcularValorEstoque(){
  float valor;
  valor = getQnt() * getPreco();
  valor *= 0.9;
  return valor;
}

legumes::legumes(string nome, float preco, int qnt):
produto(nome, preco, qnt)
{};
legumes::legumes(){};

float legumes::calcularValorEstoque(){
  float valor;
  valor = getQnt() * getPreco();
  return valor;
}

verdura::verdura(string nome, float preco, int qnt):
produto(nome, preco, qnt)
{};
verdura::verdura(){};
